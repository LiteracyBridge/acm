...
//    }
    ...
    String getFriendlyName() {
        if (mFriendlyName == null) {
            mFriendlyName = new App().getConfig().getFriendlyName(mProgramId);
        }
...
//        if (StringUtils.isNotBlank(mRevision))
     ...
     */
    boolean startDownload(App applicationContext, ContentDownloader.DownloadListener listener) {
    ...
    public Map<String, CommunityInfo> getCommunities() {
        // TODO: implement getCommunities function
