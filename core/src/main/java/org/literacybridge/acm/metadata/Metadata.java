...
public class Metadata implements Persistable {
	...
	public <F> List<MetadataValue<F>> getMetadataValues(MetadataField<F> field) {
        ...
        private <F> void addMetadataToPersistenceObject(MetadataField<F> field, MetadataValue<F> value) {
            ...
            if (field == MetadataSpecification.DC_CONTRIBUTOR) {
                ...
                mMetadata.setLb_copy_count(Integer.parseInt(value.getValue().toString()));
            } else if (field == MetadataSpecification.LB_PLAY_COUNT) {
                mMetadata.setLb_play_count(Integer.parseInt(value.getValue().toString()));
        ...
        private void refreshFieldsFromPersistenceObject() {
            try {
                isRefreshing = true;
                this.fields.clear();
                addMetadataField(MetadataSpecification.DC_CONTRIBUTOR, new MetadataValue<String>(mMetadata.getDc_contributor()));
                addMetadataField(MetadataSpecification.DC_COVERAGE, new MetadataValue<String>(mMetadata.getDc_coverage()));
                addMetadataField(MetadataSpecification.DC_CREATOR, new MetadataValue<String>(mMetadata.getDc_creator()));
                //addMetadataField(MetadataSpecification.DC_DATE, new MetadataValue<String>(mMetadata.getDc_date().toString()));
                addMetadataField(MetadataSpecification.DC_DESCRIPTION, new MetadataValue<String>(mMetadata.getDc_description()));
                addMetadataField(MetadataSpecification.DC_FORMAT, new MetadataValue<String>(mMetadata.getDc_format()));
                addMetadataField(MetadataSpecification.DC_IDENTIFIER, new MetadataValue<String>(mMetadata.getDc_identifier()));
                addMetadataField(MetadataSpecification.DC_PUBLISHER, new MetadataValue<String>(mMetadata.getDc_publisher()));
                addMetadataField(MetadataSpecification.DC_RELATION, new MetadataValue<String>(mMetadata.getDc_relation()));
                addMetadataField(MetadataSpecification.DC_RIGHTS, new MetadataValue<String>(mMetadata.getDc_rights()));
                addMetadataField(MetadataSpecification.DC_SOURCE, new MetadataValue<String>(mMetadata.getDc_source()));
                addMetadataField(MetadataSpecification.DC_SUBJECT, new MetadataValue<String>(mMetadata.getDc_subject()));
                addMetadataField(MetadataSpecification.DC_TITLE, new MetadataValue<String>(mMetadata.getDc_title()));
                addMetadataField(MetadataSpecification.DC_Type, new MetadataValue<String>(mMetadata.getDc_type()));
                addMetadataField(MetadataSpecification.DTB_REVISION, new MetadataValue<String>(mMetadata.getDtb_revision()));
                addMetadataField(MetadataSpecification.DTB_REVISION_DATE, new MetadataValue<String>((mMetadata.getDtb_revision_date() == null) 
                                                                                                    ? null : mMetadata.getDtb_revision_date().toString()));
                addMetadataField(MetadataSpecification.DTB_REVISION_DESCRIPTION, new MetadataValue<String>(mMetadata.getDtb_revision_description()));
                addMetadataField(MetadataSpecification.LB_COPY_COUNT, new MetadataValue<Integer>(mMetadata.getLb_copy_count()));
                addMetadataField(MetadataSpecification.LB_PLAY_COUNT, new MetadataValue<Integer>(mMetadata.getLb_play_count()));
                addMetadataField(MetadataSpecification.LB_RATING, new MetadataValue<Integer>((mMetadata.getLb_rating() == null) 
                                                                                             ? null : mMetadata.getLb_rating().intValue()));
            } catch (Exception e) {
