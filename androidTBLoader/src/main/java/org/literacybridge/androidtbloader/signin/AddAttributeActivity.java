...
public class AddAttributeActivity extends AppCompatActivity {
    ...
    void init() {
        ...
        updateDropdownList(UserHelper.getNewAvailableOptions());
    ...
    private void addAttribute() {
        if(attributeSelected != null) {
            ...
            UserHelper.getPool().getUser(UserHelper.getUserId()).updateAttributesInBackground(newAttribute, updateHandler);
        }
    }

    // Get user details from CIP service
    private void getDetails() {
        UserHelper.getPool().getUser(UserHelper.getUserId()).getDetailsInBackground(detailsHandler);
    }
    ...
    UpdateAttributesHandler updateHandler = new UpdateAttributesHandler() {
        ...
        public void onSuccess(List<CognitoUserCodeDeliveryDetails> attributesVerificationList) {
            // Update successful
            UserHelper.addCurrUserattribute(attributeSelected);
            updateDropdownList(UserHelper.getNewAvailableOptions());
        ...
        public void onFailure(Exception exception) {
            // Update failed
            closeWaitDialog();
            showDialogMessage("Failed to add attribute", UserHelper.formatException(exception));
        }
    };
