...
public class Persistence {
    ...
    public static synchronized void initialize() throws Exception {
        setDBSystemDir(Configuration.getConfiguration().getDatabaseDirectory());
    ...
    public static void LoadAndInitializeSettings() throws Exception {
    	if (sConnectionProperties == null) {
    		...
    		try {      	
	            ...
	            InputStream is = Persistence.class.getResourceAsStream("/" + DB_CONNECTION_PROPS_FILE);
	            sConnectionProperties.load(is);
