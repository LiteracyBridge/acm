...
public class MessageBus {
  ...
  public void addListener(Class<? extends Message> messageType,
  ...
  public void sendMessage(Message message) {
    Set<Class<? extends Message>> listOfUniqueClasses = this.messageSuperClassChainCache
    ...
    if (listOfUniqueClasses == null) {
      ...
      this.messageSuperClassChainCache.put(message.getClass(),
          listOfUniqueClasses);
    }
