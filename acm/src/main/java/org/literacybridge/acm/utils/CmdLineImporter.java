...
public class CmdLineImporter {
  ...
  private static void printUsage(CmdLineParser parser) {
    System.err.println(
        "java -cp acm.jar:lib/* org.literacybridge.acm.utils [-r] -acm <acm_name> <dir1> [<dir2> ...]");
    parser.printUsage(System.err);
  }

  private static void gatherFiles(Set<File> inputDirs, Set<File> filesToImport,
  ...
  private static void logError(File a18File, Exception exception) {
    File errorFile = new File(a18File.getParentFile(),
        a18File.getName() + ".error.txt");
