...
public class ImportableAudioMatcher extends Matcher<ImportableAudioItem, ImportableFile, MatchableImportableAudio>  {
    public void sortByProgramSpecification() {
        matchableItems.sort(new Comparator<MatchableImportableAudio>() {
            @Override
            public int compare(MatchableImportableAudio o1, MatchableImportableAudio o2) {
