 ...
 */
public class AudioItemVolumeNormalizationDialog extends JDialog {
//    TODO; rewrite for audio volume normalizatoin
    ...
    private List<AudioItem> selectedAudioItems;

    public AudioItemVolumeNormalizationDialog(final JFrame parent, AudioItem... audioItems) {
        super(parent, "Modify Volume", ModalityType.APPLICATION_MODAL);

        this.selectedAudioItems = Arrays.asList(audioItems);
//        loadProgramSpec();
//
...
//        }
        ...
        this.renamePrompt.setText("Enter volume level:");
...
//        }
        ...
        removeFromPlaylist = new JCheckBox("Replace");
...
//        } else {
//            renamePrompt.setText("Enter volume level:");
//        }
...
//    }
     ...
     */
    private void onOk() {
//        TODO: implement audio normalization here
        System.out.println("Implement audio normalization");
        try {
