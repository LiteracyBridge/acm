...
public class GreetingsImportedPage extends AcmAssistantPage<GreetingsImportContext> {
    ...
    protected GreetingsImportedPage(Assistant.PageHelper<GreetingsImportContext> listener) {
        super(listener);
    ...
    private void performImports() {
        ...
        context.matcher.matchableItems.stream()
    ...
    private void copyOrConvert(GreetingsTarget target, File fromFile, File toFile)
