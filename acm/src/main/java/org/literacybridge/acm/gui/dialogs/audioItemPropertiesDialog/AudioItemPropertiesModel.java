...
import org.literacybridge.acm.audioconverter.api.AudioVolumeModifier;
...
//                TODO; modify audio file on disk
                ...
                AudioVolumeModifier modifier = new AudioVolumeModifier();
                try {
                    modifier.modifyAudio(audioItem, newValue.toString());
                    audioItem.getMetadata().putMetadataField(
                            LB_VOLUME, new MetadataValue<>(newValue.toString()));
                } catch (BaseAudioConverter.ConversionException | AudioItemRepository.UnsupportedFormatException |
                         IOException e) {
