...
public class AudioItemPropertiesDialog extends ACMDialog implements Observer {
  ...
  private void createControlsForAvailableProperties() {
    ...
    backBtn = new JButton(LabelProvider.getLabel("GOTO_PREV_AUDIO_ITEM",
    ...
    nextBtn = new JButton(LabelProvider.getLabel("GOTO_NEXT_AUDIO_ITEM",
        LanguageUtil.getUILanguage()));
    ...
    final HighlightPredicate predicate = new HighlightPredicate() {
      @Override
      public boolean isHighlighted(Component comnponent,
          ComponentAdapter adapter) {
        return ((AudioItemPropertiesModel) propertiesTable.getModel())
            .highlightRow(adapter.row);
      }
    };
    ...
    btnClose = new JButton(
        LabelProvider.getLabel("CLOSE", LanguageUtil.getUILanguage()));
