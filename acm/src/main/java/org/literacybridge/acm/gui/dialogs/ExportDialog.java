...
public class ExportDialog extends JDialog implements ActionListener {
  private static final Logger LOG = Logger
      .getLogger(ExportDialog.class.getName());
  ...
  public ExportDialog(AudioItem[] selectedAudioItems) {
    ...
    exportDirectoryChooser.setApproveButtonText(
        LabelProvider.getLabel("EXPORT", LanguageUtil.getUILanguage()));
    ...
    c2.add(new JLabel(
        LabelProvider.getLabel("EXPORT_FORMAT", LanguageUtil.getUILanguage())));
  ...
  private void export(final File target) {
    ...
    if (csvButton.isSelected()) {
      ...
      final boolean idInFilename = idOnlyButton.isSelected()
