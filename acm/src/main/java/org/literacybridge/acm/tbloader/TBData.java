...
public class TBData {
  public static void aggregate() {
    String line;
    try {
      BufferedWriter bwMain = new BufferedWriter(
          new FileWriter("tbdata-v01-main.csv", false));
      BufferedWriter bwRotations = new BufferedWriter(
          new FileWriter("tbdata-v01-rotations.csv", false));
