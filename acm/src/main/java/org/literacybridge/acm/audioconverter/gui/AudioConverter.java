...
public class AudioConverter extends JFrame
  ...
  // buttons
  JButton sourceButton, targetButton, convertButton, optionsButton,
      detailsButton, checkAllButton, uncheckAllButton;
  // text fields
    ...
    for (Class<? extends BaseAudioConverter> clazz : ConverterClasses) {
      try {
        ...
        JOptionPane.showMessageDialog(this,
            ...
            "Converter initializatoin problem", JOptionPane.ERROR_MESSAGE,
            null);
      }
    }
  ...
  private void buildControls(boolean bShowDetails) {
    ...
    if (sourceDirPath != null)
      sourceDir.setText(sourceDirPath);
    ...
    JScrollPane tmp = new JScrollPane(ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS,
    ...
    if (targetDirPath != null)
      targetDir.setText(targetDirPath);
  ...
  private void buildDetailsPanel() {
    ...
    gbc.gridy = row;
    okScrollPane = new JScrollPane(ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS,
        ScrollPaneConstants.HORIZONTAL_SCROLLBAR_ALWAYS);
    ...
    gbc.gridy = row;
    badScrollPane = new JScrollPane(ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS,
        ScrollPaneConstants.HORIZONTAL_SCROLLBAR_ALWAYS);
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (e.getSource() == sourceButton) {
      ...
      if (sourceDirPath != null)
        fc = new JFileChooser(sourceDirPath);
      else if (this.sourceDir.getText().length() != 0)
        fc = new JFileChooser(this.sourceDir.getText());
      else
        fc = new JFileChooser();
      ...
      JFileChooser fc = null;
      if (targetDirPath != null)
        fc = new JFileChooser(targetDirPath);
      else if (this.targetDir.getText().length() != 0)
        fc = new JFileChooser(this.targetDir.getText());
      else
        fc = new JFileChooser();
      ...
      if (currentConverter != null && fileModel != null) {
        ...
        JOptionPane.showMessageDialog(this,
            "Please choose a target format for the conversion",
            "Converter Error", JOptionPane.ERROR_MESSAGE, null);
        return;
      }
    }
  }
  ...
  private void updateFileTable() {
    ...
    if (fileModel != null && fileTableMode != null) {
      ...
      if (curSel == 0) { // default
        ...
        fileModel.showOnlyFilesWithExtension(
            currentConverter.getSourceFileExtensions());
        fileTableMode.updateTable();
      }
    }
  }
