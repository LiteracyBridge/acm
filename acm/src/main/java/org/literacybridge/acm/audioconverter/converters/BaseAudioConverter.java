...
public abstract class BaseAudioConverter {
    ...
    public String convertFile(File inputFile,
        ...
        ConversionResult result = doConvertFile(inputFile, outputFile.getParentFile(), outputFile, parameters);
    ...
    static void validateConverterExecutable(String exePath, boolean listenToStdErr, String outputPrefix)
    throws AudioConverterInitializationException {
    ...
    public static class AudioConverterException extends Exception {
        ...
        public AudioConverterException(String msg, Throwable cause) {
            super(msg, cause);
        }
    }
    ...
    public static class ConversionSourceMissingException extends ConversionException {
        ...
        public ConversionSourceMissingException(String msg) {
            super(msg);
        }
